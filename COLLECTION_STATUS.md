...
|------|:----:|:-------:|:--------:|:--------:|:----------:|:------:|:-----:|:-----:|:------:|------|
| Lenny Rachitsky | ✅ | ✅ | 290 | 9 | 25 | 1 | 0 | 0 | P0 | ✅ 290集转录已导入（ChatPRD来源）；✅ Phase 3轮次4完成：23个核心框架（新增PM招聘面试/SaaS定价策略/客户访谈最佳实践/功能发布/高绩效团队建设）；✅ 2026-03-17新增9篇决策相关核心文章（决策框架/优先级/PMF/不确定性/SaaS定价/增长渠道/职业路径/Annie Duke/Shreyas Doshi访谈） |
| Brian Chesky | ✅ | ✅ | 10 | 1 | 15 | 1 | 0 | 1 | P0 | ✅ 语录集完成(50+条)；框架最丰富；✅ 决策案例库启动（Case-01: COVID-19生存决策，~8500字A级案例，完整记录2020年危机决策：裁员25%+战略聚焦+产品线削减，8个月后IPO市值$100B，6个核心启发式规则：危机聚焦/裁员平衡/透明沟通/悲观规划/回归初心/估值反弹公式），decision-cases总数 0→1 |
| Marty Cagan | ✅ | ✅ | 8 | 1 | 12 | 0 | 3 | 1 | P0 | ✅ 三本书摘要完成(Inspired/Empowered/Transformed) + 1个决策案例(BBC Mobile产品愿景) |
...
P0 - 核心人物深度扩充：
  ...
  [x] brian-chesky: ✅ 已完成 profile + 10 podcasts + 1 articles + 15 frameworks + 1 quotes + **2 decision-cases** (2026-03-19) — 语录集50+条，决策案例库启动 | ✅ **Phase 3轮次3完成**（2026-03-19 01:30）：决策案例扩充，新增 Case-02 Founder Mode 转型决策（~36KB A级文档，12000字完整决策分析），完整记录 Brian Chesky 在 2020年疫情后如何反思硅谷"标准管理模式"失效、学习Steve Jobs方法、从委托管理转向创始人深度参与的完整决策过程：背景（Manager Mode陷阱/组织碎片化）→ 选项对比（维持现状 vs 轻度调整 vs 激进重组）→ 决策理由（Steve Jobs验证/被两面欺骗感受）→ 执行细节（关闭部门/职能型组织/单一路线图/CEO产品评审/Skip-Level机制）→ 结果（2021年收入+77%/自由现金流率跻身硅谷顶级/引发Founder Mode全球讨论），包含10个核心启发式规则（Manager Mode陷阱识别/组织结构决定执行/单一路线图原则/Leadership=Presence/Skip-Level常态化/学习Jobs但不盲模仿/危机是变革窗口/Fiefdom识别拆除/职能型组织边界/对抗Professional Fakers）+ 3个反向启发式（不盲从硅谷建议/不为微管找借口/明确授权边界），多来源A级验证（Paul Graham原文/Fortune播客/Decoder访谈/Airbnb财报），为产品领导力和组织设计提供完整思维框架，decision-cases总数 1→2
  [x] marty-cagan: ✅ 已完成 profile + 12 frameworks + 3 books + 8 podcasts + 1 decision-case (2026-03-19) — Inspired/Empowered/Transformed书籍摘要、Four Big Risks/Product vs Feature Teams/Missionaries vs Mercenaries等12个框架 | **Phase 4轮次1完成**（2026-03-19 15:00）：新增2个重要播客访谈（2024年Product Compass关于Transformed & Product Operating Model深度访谈/2022年20VC关于Four Questions & Product Team Hiring最佳实践），podcasts总数6→8，补充Product Management Theater现象剖析、Feature Team vs Product Team本质区别、转型三大支柱、四大风险框架完整应用、从Marc Andreessen/Ben Horowitz/Pierre Omidyar学到的经验、PM招聘&Onboarding最佳实践完整体系，~14KB A级文档，多来源验证(Product Compass/Aakash Gupta/20VC/SVPG官方)，为产品管理方法论建立系统性参考 | **Phase 4轮次2完成**（2026-03-19 20:00）：决策案例库启动，新增Case-01 BBC Mobile产品愿景决策（~11KB A级文档），完整记录Alex Pressland在2003-2007年如何推动BBC从广播内容到内容分发平台的战略转型，包含背景（内容联合分发技术+Out Of Home用户需求）/3个选项对比/决策理由（技术洞察×用户需求交集/与BBC使命对齐/战略窗口期）/执行过程（说服编辑部/解决法律障碍/提出完整愿景）/结果（5000万+周活用户/组织能力转型/人才培养），提炼7个核心启发式（产品愿景来自技术×需求交集/用使命而非技术说服高层/早期实验建立信心/在窗口期前行动/用证据挑战文化/force of will/PM as Mini-CEO）+ 3个反向启发式，SVPG官方案例研究（Marty Cagan亲自撰写"Behind Every Great Product"），为产品愿景和组织转型决策建立参考模板，decision-cases总数0→1
  ...
  [x] zhang-xiaolong: ✅ 已完成 profile + 6 frameworks + 2 podcasts + 1 books + 22 articles + 1 quotes + 6 talks + 3 interviews + **22 decision cases** + **1 evolution timeline** + **1 controversies analysis** (2026-03-19) — Core Principles, Discovering Needs, Product Design, Great Product, Product Temperament, Product Details | 2017/2019公开课演讲、推荐10本好书、产品世界观、腾讯内刊专访、新华社采访、产品方法论、语录集、2016/2017/2018/2020/2021微信公开课演讲 | **Phase 0轮次1最新批**：新增2篇重要文章(2019年极客公园4小时演讲《微信的原动力与未来》+2021年微信设计理念对话精华)，articles总数20→22篇，补充10亿DAU里程碑反思、产品评审流程(砍掉70%需求)、禁用竞品规定、克制理念完整阐述、小程序/企业微信/微信支付战略思考、团队管理哲学(不看原型/反复打磨/独立思考)、设计原则六大支柱(极简/克制/场景/体验/独立/长期)，~16KB A级文档，深度产品哲学系统化呈现 | **Phase 0轮次1持续**：新增1篇关键文章(2017年1月小程序发布演讲《全面阐述小程序理念与设计》90分钟完整演讲)，articles总数19→20篇，补充小程序八大核心设计(无入口/二维码触达/不做分发/社交推荐优于算法/访问关系非粉丝/不推送/群协作/有限搜索)、工具思维vs平台思维、去中心化哲学、"用完即走"产品理念、克制的本质(非自我压制而是理所应当)，12KB A级官方演讲记录，标志性产品决策演讲 | **Phase 0轮次1完成前批**：新增1篇关键文章(2020年微信公开课PRO《信息互联的7个思考》视频演讲完整记录)，articles总数18→19篇，补充信息时代哲学思考、隐私与便利权衡、社会关系扩大、信息传播快速、公众号两大失误反思、短内容战略预告(视频号雏形)、组织能力考验完整体系，11800字A级文档，标志张小龙从一线演讲退居幕后转折点 | Phase 0轮次1完成第二批：新增2篇关键文章(2015年微信公开课PRO版八大理念+2012年微信背后的产品观演讲)，articles总数16→18篇，补充公众平台理念(去中心化/生态系统/动态系统)和产品设计哲学(简单之美/人性洞察/摇一摇案例) | **P0完成** 决策案例库22个案例(新增小程序战略决策)：10核心+12扩展，~265KB证据+73启发式 | **P1完成** 观点演化时间线(2000-2021)：五阶段轨迹+5大观点演化(工具/用户/社交/平台/克制)+3转折点+高频词统计+不变量提炼，8000字A级分析 | **P1完成** 反例与争议材料(2026-03-18 19:00)：~18KB系统性分析，覆盖张小龙承认的2个失误(短视频风口/公众号路径依赖)、3个用户强烈反对功能(已读/朋友圈广告/提现收费)、3个失败产品(漂流瓶/微信电话本/边缘化功能)、3个业界批评维度(过度克制/封闭生态/言论审查)、能力边界明确化(✅熟人社交⚠️陌生人社交⚠️内容平台)、8个反向启发式，A级证据多源验证，为Persona建立边界感 | **Phase 0轮次7完成**：综合查漏新增1篇内部分享（2016年WXG领导力大会：KPI是副产品/警惕复杂流程/敏捷团队/轮岗机制），talks总数5→6篇，补充管理哲学、组织效能、QQ邮箱敏捷转型完整经验
