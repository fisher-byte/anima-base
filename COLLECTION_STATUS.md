...
|------|:----:|:-------:|:--------:|:--------:|:----------:|:------:|:-----:|:-----:|:------:|------|
| Lenny Rachitsky | ✅ | ✅ | 3 | 0 | 1 | 1 | 0 | 0 | P0 | Lenny Space 核心来源，需扩充至全量320+集 |
...
| Elena Verna | ✅ | — | 0 | 0 | 0 | 0 | 0 | 0 | P2 | 空目录，待启动 |
...
| Satya Nadella | ✅ | — | 0 | 0 | 0 | 0 | 0 | 0 | P2 | 空目录 |
| Reed Hastings | ✅ | — | 0 | 0 | 0 | 0 | 0 | 0 | P2 | 空目录，需补 No Rules Rules |
| Andy Grove | ✅ | — | 0 | 0 | 0 | 0 | 0 | 0 | P3 | 空目录 |

### Startup（创业）

| 人物 | 目录 | profile | podcasts | articles | frameworks | quotes | books | talks | 优先级 | 备注 |
|------|:----:|:-------:|:--------:|:--------:|:----------:|:------:|:-----:|:-----:|:------:|------|
| Paul Graham | ✅ | — | 0 | 2 | 0 | 0 | 0 | 0 | P1 | 有文章，需补 profile 和更多 PG Essays |
...
```
P0 - 核心人物深度扩充：
  [ ] lenny-rachitsky: podcasts 扩充至 20+ 集
...
P1 - 有 profile 但内容稀薄的人物：
  ...
  [ ] paul-graham: 建 profile.md，补充更多 essays
