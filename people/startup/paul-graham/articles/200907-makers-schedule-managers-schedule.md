...
tags: [productivity, time-management, meetings, programming, creativity, focus]
---
...
## Y Combinator's Solution: Office Hours
...
Several times a week I set aside a chunk of time to meet founders we've funded. These chunks of time are:
- At the end of my working day
- Clustered together (signup program ensures this)
- Never an interruption (they come at the end)

During busy periods, office hours sometimes get long enough that they compress the day, but they never interrupt it.

## Personal Solution: Two Workdays
...
Business people in Silicon Valley have speculative meetings all the time. They're effectively free if you're on the manager's schedule. They're so common that there's distinctive language for proposing them: saying that you want to "grab coffee," for example.

**Speculative meetings are terribly costly if you're on the maker's schedule, though.**

## The Bind

This puts us in something of a bind. Everyone assumes that, like other investors, we run on the manager's schedule. So they introduce us to someone they think we ought to meet, or send us an email proposing we grab coffee.

At this point we have two options, neither of them good:
1. Meet with them, and lose half a day's work
2. Try to avoid meeting them, and probably offend them

## The Solution

Perhaps there's a third option: to write something explaining the two types of schedule. Maybe eventually, if the conflict between the manager's schedule and the maker's schedule starts to be more widely understood, it will become less of a problem.

**Those of us on the maker's schedule are willing to compromise**. We know we have to have some number of meetings. All we ask from those on the manager's schedule is that they **understand the cost**.

---

**Core Takeaway**: Makers (programmers, writers) need long uninterrupted blocks of time to do deep work, while managers work in hour-long segments. A single meeting can destroy a maker's entire day by fragmenting it. Understanding this difference is crucial for effective collaboration.

**Source**: [paulgraham.com/makersschedule.html](https://paulgraham.com/makersschedule.html)
